 ...
 *
 * If the 'child' type is used then any time a checkbox
 * is checked all child options will also be checked.
 *
 * @package   Swat
 * @copyright 2021 silverorange
 * @license   http://www.gnu.org/copyleft/lesser.html LGPL License 2.1
 */
class SwatCheckboxParentDependencyTree extends SwatCheckboxTree
{
    ...
    public function __construct($id = null)
    {
        ...
        $this->addJavaScript(
            'packages/swat/javascript/swat-checkbox-parent-dependency-tree.js'
        );
    }
