...
class SwatTextareaEditor extends SwatTextarea
{
    ...
    public function __construct($id = null)
    {
        ...
        //$this->addJavaScript('https://cdn.tiny.cloud/1/mr7jywshgpa7hj8gp3njmyobnx8qz4ll5c7p115n3ls0knq4/tinymce/5/tinymce.min.js');
        $this->html_head_entry_set->addEntry(
            new SwatJavaScriptHtmlHeadEntry('https://cdn.tiny.cloud/1/mr7jywshgpa7hj8gp3njmyobnx8qz4ll5c7p115n3ls0knq4/tinymce/5/tinymce.min.js')
        );
        $this->addJavaScript(
